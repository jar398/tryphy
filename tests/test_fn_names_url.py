...
class TestFnNamesUrl(webapp.WebappTestCase):
    ...
    def test_no_parameter(self):
        ...
        self.assertTrue(u'url' in x.json()[u'message'])
    ...
    # See what happens when you give it a big file of an unrecognized type.
    ...
    def test_2(self):
        ...
        print >>sys.stderr, x.json()[u'scientificNames'][0:10]
